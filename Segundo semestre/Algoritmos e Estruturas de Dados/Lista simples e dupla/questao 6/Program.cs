...
class ListaDupla {
    ...
    public int recursivoDuplo(int z){
        if(primeiro == ultimo){
            return z;
        }
        else{
            primeiro = primeiro.Prox;
            return recursivoDuplo(z + 1);
        }
    }
...
class Program {
    ...
    static void Main() {
        ...
        for(int i = 0; i < 5; i++){
            ...
            lista2.InserirInicio(x);
        }

        int resultado = lista.recursivo(y);
        int resultado2 = lista2.recursivoDuplo(z);
        Console.Write("Tamanho da lista simples: " + resultado);
        Console.WriteLine(" ");
        Console.Write("Tamanho da lista dupla: " + resultado2);
